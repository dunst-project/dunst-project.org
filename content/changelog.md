...
## 1.12.0 -- 2024-11-30  <div class="releaseref"><i class="fa fa-sticky-note"></i> [Release Notes]({{< ref "/release#v1.12.0" >}})</div> {#v1.12.0}
...
## 1.11.0 -- 2024-04-15  <div class="releaseref"><i class="fa fa-sticky-note"></i> [Release Notes]({{< ref "/release#v1.11.0" >}})</div> {#v1.11.0}
...
## 1.10.0 -- 2024-02-19  <div class="releaseref"><i class="fa fa-sticky-note"></i> [Release Notes]({{< ref "/release#v1.10.0" >}})</div> {#v1.10.0}
...
## 1.9.2 -- 2023-04-20  <div class="releaseref"><i class="fa fa-sticky-note"></i> [Release Notes]({{< ref "/release#v1.9.2" >}})</div> {#v1.9.2}
...
## 1.9.1 -- 2023-03-08  <div class="releaseref"><i class="fa fa-sticky-note"></i> [Release Notes]({{< ref "/release#v1.9.1" >}})</div> {#v1.9.1}
...
## 1.9.0 -- 2022-06-27  <div class="releaseref"><i class="fa fa-sticky-note"></i> [Release Notes]({{< ref "/release#v1.9.0" >}})</div> {#v1.9.0}
...
## 1.8.1 -- 2022-03-02  <div class="releaseref"><i class="fa fa-sticky-note"></i> [Release Notes]({{< ref "/release#v1.8.1" >}})</div> {#v1.8.1}

### Fixed
- Dunst sometimes not using the right config file, sometimes falling back to the
  internal defaults.

## 1.8.0 -- 2022-02-24  <div class="releaseref"><i class="fa fa-sticky-note"></i> [Release Notes]({{< ref "/release#v1.8.0" >}})</div> {#v1.8.0}
...
- Updated default values documentation (with help from @profpatch) ([#1004](https://github.com/dunst-project/dunst/issues/1004) and
  more)


## 1.7.3 -- 2021-12-08  <div class="releaseref"><i class="fa fa-sticky-note"></i> [Release Notes]({{< ref "/release#v1.7.3" >}})</div> {#v1.7.3}
...
## 1.7.2 -- 2021-11-30  <div class="releaseref"><i class="fa fa-sticky-note"></i> [Release Notes]({{< ref "/release#v1.7.2" >}})</div> {#v1.7.2}
...
## 1.7.1 -- 2021-11-01  <div class="releaseref"><i class="fa fa-sticky-note"></i> [Release Notes]({{< ref "/release#v1.7.1" >}})</div> {#v1.7.1}
...
## 1.7.0 -- 2021-10-19:  <div class="releaseref"><i class="fa fa-sticky-note"></i> [Release Notes]({{< ref "/release#v1.7.0" >}})</div> {#v1.7.0}
...
## 1.6.1 - 2021-02-21:  <div class="releaseref"><i class="fa fa-sticky-note"></i> [Release Notes]({{< ref "/release#v1.6.1" >}})</div> {#v1.6.1}

### Fixed
- Incorrect version in Makefile

## 1.6.0 - 2021-02-21:  <div class="releaseref"><i class="fa fa-sticky-note"></i> [Release Notes]({{< ref "/release#v1.6.0" >}})</div> {#v1.6.0}
...
## 1.5.0 - 2020-07-23  <div class="releaseref"><i class="fa fa-sticky-note"></i> [Release Notes]({{< ref "/release#v1.5.0" >}})</div> {#v1.5.0}
...
## 1.4.1 - 2019-07-03  <div class="releaseref"><i class="fa fa-sticky-note"></i> [Release Notes]({{< ref "/release#v1.4.1" >}})</div> {#v1.4.1}
...
## 1.4.0 - 2019-03-30  <div class="releaseref"><i class="fa fa-sticky-note"></i> [Release Notes]({{< ref "/release#v1.4.0" >}})</div> {#v1.4.0}
...
## 1.3.2 - 2018-05-06  <div class="releaseref"><i class="fa fa-sticky-note"></i> [Release Notes]({{< ref "/release#v1.3.2" >}})</div> {#v1.3.2}

### Fixed

- Crash when trying to load an invalid or corrupt icon ([#512](https://github.com/dunst-project/dunst/issues/512))

## 1.3.1 - 2018-01-30  <div class="releaseref"><i class="fa fa-sticky-note"></i> [Release Notes]({{< ref "/release#v1.3.1" >}})</div> {#v1.3.1}

### Fixed

- Race condition resulting in the service files being empty ([#488](https://github.com/dunst-project/dunst/issues/488))

## 1.3.0 - 2018-01-05  <div class="releaseref"><i class="fa fa-sticky-note"></i> [Release Notes]({{< ref "/release#v1.3.0" >}})</div> {#v1.3.0}
...
## 1.2.0 - 2017-07-12  <div class="releaseref"><i class="fa fa-sticky-note"></i> [Release Notes]({{< ref "/release#v1.2.0" >}})</div> {#v1.2.0}
...
## 1.1.0 - 2014-07-29  <div class="releaseref"><i class="fa fa-sticky-note"></i> [Release Notes]({{< ref "/release#v1.1.0" >}})</div> {#v1.1.0}
...
## 1.0.0 - 2013-04-15  <div class="releaseref"><i class="fa fa-sticky-note"></i> [Release Notes]({{< ref "/release#v1.0.0" >}})</div> {#v1.0.0}
...
## 0.5.0 - 2013-01-26  <div class="releaseref"><i class="fa fa-sticky-note"></i> [Release Notes]({{< ref "/release#v0.5.0" >}})</div> {#v0.5.0}
- new default dunstrc
- frames for window
...
## 0.4.0 - 2012-09-27  <div class="releaseref"><i class="fa fa-sticky-note"></i> [Release Notes]({{< ref "/release#v0.4.0" >}})</div> {#v0.4.0}
...
## 0.3.1 - 2012-08-02  <div class="releaseref"><i class="fa fa-sticky-note"></i> [Release Notes]({{< ref "/release#v0.3.1" >}})</div> {#v0.3.1}
- fix -mon option

## 0.3.0 - 2012-07-30  <div class="releaseref"><i class="fa fa-sticky-note"></i> [Release Notes]({{< ref "/release#v0.3.0" >}})</div> {#v0.3.0}
...
## 0.2.0 - 2012-06-26  <div class="releaseref"><i class="fa fa-sticky-note"></i> [Release Notes]({{< ref "/release#v0.2.0" >}})</div> {#v0.2.0}
